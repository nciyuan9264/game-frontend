...
import { WsMatchSyncData as WsMatchSyncDataTypeAcquire } from '@/types/AcquireRoom';
import { WsMatchSyncData as WsMatchSyncDataTypeDaVinci } from '@/types/DaVinicRoom';
...
interface UseSeatActionParams {
  data: Seat;
  userID: string;
  wsMatchSyncData?: WsMatchSyncDataTypeAcquire | WsMatchSyncDataTypeDaVinci;
