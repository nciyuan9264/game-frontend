      ...
      <div className={styles.leftSection}>
        ...
        <div className={styles.gameInfo}>
          ...
          <div className={styles.infoItem}>
            ...
            <Text className={styles.infoText} ellipsis={{ tooltip: true }}>{backendName2FrontendName(userID)}</Text>
          </div>
        </div>
          ...
          {data?.roomData.roomInfo.roomStatus ? (
            data?.roomData.currentPlayer === userID ? (
              ...
              <div className={styles.waitingTurn}>
                等待 <span className={styles.playerName}>{backendName2FrontendName(data.roomData.currentPlayer)}</span> 操作
              </div>
            )
          ) : (
